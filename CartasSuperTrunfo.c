...
int main() {
    ...
    int pontosturisticos1, pontosturisticos2, resultadoPop, resultadoArea, resultadoPib, resultadoPontosTu, resultadoDensiPop, resultadoPibCap, resultadoSuperP;
    ...
    resultadoPontosTu = pontosturisticos1 > pontosturisticos2;
    resultadoDensiPop = densidadepopulacional1 < densidadepopulacional2;
    resultadoPibCap = pibpercapita1 > pibpercapita2;
    ...
    printf("Pontos Turísticos: Carta %d venceu (%d)\n", resultadoPontosTu ?1:2, resultadoPontosTu);
    printf("Densidade Populacional: Carta %d venceu (%d)\n", resultadoDensiPop ?1:2, resultadoDensiPop);
    printf("PIB per Capita: Carta %d venceu (%d)\n", resultadoPibCap ?1:2, resultadoPibCap);
    printf("Super Poder: Carta %d venceu (%d)\n", resultadoSuperP ?1:2, resultadoSuperP);
    printf("--------------------------------------------\n");
    return 0;
